...
def shoe_size(player_name)
  game_hash.each do |location, team_data|
       team_data.each do |attribute, data|	          team_data[:players].each do |players, p_hash|
         if attribute == :players	            if p_hash[:name] == player_name
          data.each do |key, value|	              return p_hash[:shoe]
end
end
end
end
